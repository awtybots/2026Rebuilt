...
public final class Configs {
        ...
        public static final class ClimberSubsystem {
            ...
            public static final SparkFlexConfig CLIMBERMOTOR_LEFT_CONFIG = new SparkFlexConfig();
            public static final SparkFlexConfig CLIMBERMOTOR_RIGHT_CONFIG = new SparkFlexConfig();


                static {

                        CLIMBERMOTOR_LEFT_CONFIG.idleMode(IdleMode.kBrake).smartCurrentLimit(50).voltageCompensation(12);
                        CLIMBERMOTOR_RIGHT_CONFIG.idleMode(IdleMode.kBrake).smartCurrentLimit(50).voltageCompensation(12);


                        CLIMBERMOTOR_LEFT_CONFIG.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder)
                        CLIMBERMOTOR_RIGHT_CONFIG.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder)
                            // Set PID values for position control. We don't need to pass a closed
                            // loop slot, as it will default to slot 0.
                            .p(0.4)
                            .i(0)

...
public class Climber extends SubsystemBase {
    ...
    public Climber(){
        ClimbMotorLeft.configure(Configs.ClimberSubsystem.CLIMBERMOTOR_LEFT_CONFIG, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
        ClimbMotorRight.configure(Configs.ClimberSubsystem.CLIMBERMOTOR_LEFT_CONFIG, ResetMode.kResetSafeParameters, PersistMode.kPersistParameters);
    }
